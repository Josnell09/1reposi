    ...
    public partial class Form1 : Form
    {
        ...
        private void UpdateData(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dtgv1.Rows.Count; i++)
            {
                ...
                dtgv1Rows.Cells[0].Value = txtID.Text;
                dtgv1Rows.Cells[1].Value = textBoxanalista.Text;
                dtgv1Rows.Cells[2].Value = textBoxbien.Text;
            }
        }
        ...
        private void btnSave2_Click(object sender, EventArgs e)
        {
            ...
            string columna0 = dtgv1.Rows[dtgv1.Rows.Count - 1].Cells[0].Value?.ToString();
            string columna1 = dtgv1.Rows[dtgv1.Rows.Count - 1].Cells[1].Value?.ToString();
            ...
            string columna5 = dtgv1.Rows[dtgv1.Rows.Count - 1].Cells[5].Value?.ToString();
        ...
        private void UpdateTab4(int i)
        {
            ...
            if (dtgvClassification.Rows.Count < dtgvevaluacion.Rows.Count)
            {
                dtgvClassification.Rows.Add();
            }
            var dtgvClassRows = dtgvClassification.Rows[i];
            var dtgvEvaluationRows = dtgvevaluacion.Rows[i];
